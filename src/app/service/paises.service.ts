...
export class PaisesService {
  ...
  countryData =  [
   ...
   {"nombre":"Bembos La Fontana":assets/mapasretiro/bembos-la-fontana.png"},
   ...
   {"nombre":"Mall Aventura de Santa Anita #2":"assets/mapasretiro/mall-aventura-de-santa-anita-2.png"},
